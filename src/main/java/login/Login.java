...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(218, 162, 155));
        ...
        jLabel4.setText("Pasteleria");

        jLabel5.setFont(new java.awt.Font("Ubuntu", 1, 36)); // NOI18N
        jLabel5.setText("TRES REYES");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String insert = "SELECT COUNT(id) AS i FROM usuario WHERE correo ='"+u+"'" + "AND password = '"+p+"'";
        try {
            ...
            while(rs.next()){
                ...
                gui.setVisible(true);
                    ...
                    JOptionPane.showMessageDialog(null, "Usuario o contraseña invalida, vuelva a intentarlo");
            }
            }
